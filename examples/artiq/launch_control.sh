...
gnome-terminal --tab -- bash -c "source /home/ocr/miniconda3/etc/profile.d/conda.sh; conda activate artiq6; cd ~/repos/electronics-control-system-gui/notify; python server.py --address 192.168.52.2"
